<template>
  <div class="home">
    <div id="header">
      <vue-typed-js :strings="['Grocery shopping, <u>without the hassle.</u>', 'Grocery shopping, <u>with nutrition tracking.</u>', 'Grocery shopping, <u>with recipe suggestions.</u>', 'Grocery shopping, <u>with shopping rewards.</u>', 'Grocery shopping, <u>with more fun.</u>']" :typeSpeed="60" :backDelay="1600" :showCursor="false">
        <h1 class="typing"></h1>
      </vue-typed-js>
